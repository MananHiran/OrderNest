...
const UserManagement = () => {
  ...
  const roles = [
    ...
    { value: 'INVENTORY_MANAGER', label: 'Inventory Manager', color: 'bg-green-100 text-green-800' },
    { value: 'OPERATOR_MANAGER', label: 'Operator Manager', color: 'bg-yellow-100 text-yellow-800' },
    { value: 'MANUFACTURER_MANAGER', label: 'Manufacturer Manager', color: 'bg-purple-100 text-purple-800' },
